...
export function ChannelCard({
  ...
  return (
    <Link
      href={`/community/${slug}`}
      className="group surface-card surface-card-hover relative flex flex-col overflow-hidden p-4 transition-all hover:-translate-y-0.5"
      style={{ boxShadow: `inset 0 2px 0 ${color}40` }}
    >
